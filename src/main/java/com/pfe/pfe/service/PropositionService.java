...
public class PropositionService {
    ...
    public List<Proposition> findByUtilisateur(String email) {
        return propositionRepository.findByUtilisateur_EmailUtil(email);
    }
    public List<Proposition> findByDepartement(int idDepartement) {
    return propositionRepository.findByDepartement_IdDepartement(idDepartement);
}
}