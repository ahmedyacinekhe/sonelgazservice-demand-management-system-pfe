...
public class RoleUtilisateurService {
    ...
    public void deleteByIdUtil(int idUtil) {
        // Vérifier si l'utilisateur est employé/responsable AVANT suppression
        
        roleUtilisateurRepository.deleteByRoleUtilisateurId_IdUtil(idUtil);
    }
}